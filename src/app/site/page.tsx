...
export default function Home() {
  return (
    ...
    <section className="h-full  w-full pt-36 relative flex items-center justify-center flex-col " > 
      ...
      <p className="text-center mt-80">Run your agency, in one place</p>
        <div className="bg-gradient-to-r from-primary to-secondary-foreground text-transparent bg-clip-text relative">
          <h1 className="text-9xl font-bold text-center md:text-[180px]">
            QWINT
          </h1>
        </div>
    ...
    <section className="flex justify-center items-center flex-col gap-4 md:!mt-200 mt-[250px]">
